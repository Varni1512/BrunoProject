...
const BlogCard = ({ blog }) => (
  <div className="rounded-2xl overflow-hidden bg-[#080808] flex flex-col h-full drop-shadow-[0_4px_10px_#532959] w-full max-w-[420px] mx-auto">
  ...
  return (
    <>
      {isLoading ? (
        <section
          id="hero"
          className="bg-black h-screen w-full flex pt-32 justify-center"
        >
        ...
        <>
          ...
          {blogs.length > 0 && (
            <>
              <section
                id="hero"
                className="bg-black pb-8 pt-24 md:pt-24"
              >
