      ...
      <main className="flex-grow pt-48 px-4">
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <p className=" text-[rgba(251,229,216,0.68)] text-[30px]">
            Español : Qué os parece la canción que envía España este año a
            Eurovisión? A mí no me va tanto el festival, pero cuando hay algo de
            calidad, apetece escucharlo Aquí os dejo el videoclip de Melody y un
            par de ejercicios para que practiquéis vocabulario. Ya me decís qué
            os parece Buena semana, valientes!
          </p>

          {/* Exercise 1 */}
          <div className="p-6">
            <h2 className="text-[35px] font-bold mb-4 font-afacad">
              Ejercicio 1: Completa con los adjetivos correctos
            </h2>
          ...
          <div className="p-6">
            ...
            <div className="space-y-3 font-afacad text-[25px] md:text-[20px] text-white ">
              <div className="flex gap-12">
                ...
                <span className="text-[rgba(255,255,255,0.68)]">
                  a) Que no se deja vencer por el miedo.
                </span>
              </div>
              <div className="flex gap-12">
                <span className="font-semibold w-[150px]">2. Valiente</span>
                <span className="text-[rgba(255,255,255,0.68)]">
                  b) Que destaca por su gran fuerza o poder.
                </span>
              </div>
              <div className="flex gap-12">
                <span className="font-semibold w-[150px]">3. Poderosa</span>
                <span className="text-[rgba(255,255,255,0.68)]">
                  c) Que tiene humildad, no es arrogante.
                </span>
              </div>
              <div className="flex gap-12">
                <span className="font-semibold w-[150px]">4. Embrujada</span>
                <span className="text-[rgba(255,255,255,0.68)]">
                  d) Que se siente libre y sin ataduras.
                </span>
              </div>
              <div className="flex gap-12">
                <span className="font-semibold w-[150px]">5. Libre</span>
                <span className="text-[rgba(255,255,255,0.68)]">
                  e) Que está fascinada o hechizada por algo.
                </span>
              </div>
              <div className="flex gap-12">
                <span className="font-semibold w-[150px]">6. Fuerte</span>
                <span className="text-[rgba(255,255,255,0.68)]">
                  f) Que posee resistencia y vigor.
                </span>
              </div>
            </div>
          </div>
          ...
          <div className=" p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-72px ">
              <div>
                <p className="font-bold text-[30px] mb-2 text-[#DFB6B2]">
                  1. Sencilla
                </p>
              ...
              <div>
                <p className="font-bold mb-2 text-[30px] text-[#DFB6B2] whitespace-nowrap">
                  6. ¿Qué más da?
                </p>
                <ul className="list-disc pl-8 space-y-1 text-[25px] text-[#BEBEBE]">
...
export default TempBlogDetailPage;
